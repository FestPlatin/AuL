...
\begin{eqnarray*}
	t(z_{i_n},n) &=& P(Z_1=z_{i_1}, \dots, Z_n=z_{i_n}, A_1=a_1, \dots, A_n=a_n)\\
		&=& P(A_n=a_n|Z_1=z_{i_1}, \dots, Z_n=z_{i_n}, A_1=a_1, \dots, A_{n-1} = a_{n-1}) \cdot \\
		&& P(Z_1=z_{i_1}, \dots, Z_n=z_{i_n}, A_1=a_1, \dots, A_{n-1}=a_{n-1})\\
		&=& P(A_n=a_n|Z_n=z_{i_n}) \cdot \\
		&& P(Z_1=z_{i_1}, \dots, Z_n=z_{i_n}, A_1=a_1, \dots, A_{n-1}=a_{n-1})\\
		&=& q_{z_{i_n}}(a_n) \cdot\\
		&& P(Z_n=z_{i_n}|Z_1=z_{i_1}, \dots, Z_{n-1}=z_{i_{n-1}}, A_1=a_1, \dots, A_{n-1}=a_{n-1}) \cdot\\
		&& P(Z_1=z_{i_1},\dots, Z_{n-1}=z_{i_{n-1}}, A_1=a_1, \dots, A_{n-1}=a_{n-1})\\
		&=& q_{z_{i_n}}(a_n) \cdot P(Z_n=z_{i_n}|Z_{n-1}=z_{i_{n-1}}) \cdot \\
		&& P(Z_1=z_{i_1}, \dots, Z_{n-1}=z_{i_{n-1}}, A_1=a_1, \dots, A_{n-1}=a_{n-1})\\
...
Gesucht ist ein \(j\) mit \[P(Z_t=j|A_1=a_1, \dots, A_n=a_n)\] maximal.
